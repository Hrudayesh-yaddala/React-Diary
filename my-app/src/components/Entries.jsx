...
const Entries = () => {
  ...
  return (
    ...
    <div className="container mx-auto py-10">
      ...
      <Link className="px-4 py-1 text-white text-lg bg-purple-300 bg-[#a86add]rounded hover:bg-purple-400 mr-2 sm:text-base lg:text-lg" to={"/compose"}>+ NEW ENTRY</Link>
      </div>
        ...
        <tbody>
          {entries.map((entry, index) => (
            <tr key={entry._id}>
              ...
              <td className="border p-2">{entry.comment}</td>
